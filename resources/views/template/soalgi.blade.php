                        ...
                        <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                            <form action="{{ route('submit_gi', $gi->id) }}" method="POST">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="mb-1">
                                            <h4>8. Ceritakan rencana Anda seputar karier dalam jangka pendek serta
                                                jangka
                                                panjang!</h4>
                                        </div>
                                        <div class="form-floating">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="mb-1">
                                            <h4>
                                                9. Hitung berapa jumlah pasangan huruf yang memiliki perbedaan di
                                                bawah:<br />
                                                P p<br />
                                                R r<br />
                                                T r<br />
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="mb-1">
                                            <h4>
                                                ...
                                                Usia Dini 2 kali usia Ahmad. Raka lebih tua dari Dini. Siapakah yang
                                                paling
                                                tua?
                                            </h4>
                                        </div>
