            ...
            <div class="col-lg-8 wow fadeInUp mb-5" data-wow-delay="0.5s">
                <form action="{{ route('updateprofil') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="nama" name="nama" placeholder="Your Name"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                    id="tempat_lahir" name="tempat_lahir" placeholder="Your Name"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                    id="tgl_lahir" name="tgl_lahir" placeholder="Your Name"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <select class="form-control @error('jk') is-invalid @enderror" id="jk"
                                    name="jk" style="background-color: #fff;">
                                    <option value="pria" @if (Auth::user()->jk == 'pria') {{ 'selected' }} @endif>
                                        Pria</option>
                                    <option value="wanita" @if (Auth::user()->jk == 'wanita') {{ 'selected' }} @endif>
                                        Wanita</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                    id="email" name="email" value="{{ Auth::user()->email }}" readonly disabled>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary py-3 px-5" type="submit">Edit
                                Profile</button>
                        </div>
                    </div>
                </form>
                            ...
                            @forelse ($konsul as $ks)
                                <tr>
                                    ...
                                    @if ($ks->bukti_pembayaran == null || $ks->bukti_pembayaran == 'pembayaran ditolak')
                                        <td>
                                            <form action="{{ route('updatekonsul', $ks->id) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="file" name="bukti_pembayaran">
                                                <button type="submit" class="btn btn-primary">Upload</button>
                                                <p style="color: red; font-size: 10pt; text-transform: none;"
                                                    class="mb-1">*.jpg, .jpeg, .png | Max 2048 KB</p>
                                            </form>
                                        </td>
                                    @else
