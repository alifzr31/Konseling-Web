...
<head>
    ...
    <link href="{{ url('../img/logoft.png') }}" rel="icon">
            ...
            {{-- <li class="nav-item @if (Route::current()->getName() == 'listuser' || Route::current()->getName() == 'detailuser') active @endif">
                ...
                <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if (Route::current()->getName() == 'listuser' || Route::current()->getName() == 'detailuser') active @endif"
                            href="{{ route('listuser') }}">Data User</a>
                    </div>
                </div>
                <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
