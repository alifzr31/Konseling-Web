...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="text-transform: capitalize;">{{ $user->nama }}
            </li>
        </ol>
    </div>
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" class="form-control" id="exampleInputPassword1" placeholder="Alamat"
                                style="height: 150px; resize: none;">{{ $user->alamat }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="jk" class="form-control" id="exampleInputPassword1">
                                ...
                                <option value="pria" @if ($user->jk == 'pria') {{ 'selected' }} @endif>Pria
                                </option>
                                <option value="wanita" @if ($user->jk == 'wanita') {{ 'selected' }} @endif>
                                    Wanita</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">No. Telp</label>
                            <input type="tel" class="form-control" id="exampleInputPassword1" placeholder="No. Telp"
                                value="{{ $user->no_telp }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="jk" class="form-control" id="exampleInputPassword1">
                                ...
                                <option value="admin" @if ($user->jk == 'admin') {{ 'selected' }} @endif>
                                    Admin</option>
                                <option value="user" @if ($user->jk == 'user') {{ 'selected' }} @endif>
                                    User</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Email" value="{{ $user->email }}" readonly
                                disabled>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary" style="text-transform: capitalize;">Data Konsultasi
                        {{ $user->nama }}</h6>
                </div>
                                    ...
                                    <td>
                                        ...
                                        @if (!$ks->bukti_pembayaran == null)
                                            @if ($ks->status == 'menunggu konfirmasi')
                                                <a href="{{ Storage::url('public/bukti_pembayaran/') . $ks->bukti_pembayaran }}"
                                                    class="btn btn-warning" target="_blank">Bukti Pembayaran</a>
                                            ...
                                            @endif
                                        @endif
                                        <a href="{{ route('detailkonsul', $ks->id) }}" class="btn btn-primary">Detail
                                            Data</a>
                                    </td>
                                </tr>
                            @endforeach
